...
public class KafkaAvroAvscConsumerApplication implements CommandLineRunner {

	private static final Logger log = LoggerFactory.getLogger(KafkaAvroAvscConsumerApplication.class);

	public static void main(String[] args) {
		SpringApplication.run(KafkaAvroAvscConsumerApplication.class, args);
	}
